function refurb_cost = compute_refurb_cost(stage_manuf_cost, launch_schedule, learning_curve)
    ...
    for i = 1:num_launches
        if launch_schedule(i, 2) == 1
            ...
            learned_percentage = starting_percentage * refurbish_launch_count^learning_curve;
