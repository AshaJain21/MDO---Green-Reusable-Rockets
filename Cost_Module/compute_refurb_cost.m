function refurb_cost = compute_refurb_cost(stage, avg_stage_manuf_cost, num_launches, launch_schedule, parameters)
    ...
    for i = 1:num_launches
        if launch_schedule(stage+1, i) == 1
            ...
            refurb_cost_for_stage = avg_stage_manuf_cost * learned_percentage;
