...
re_mat_density = design_variables.reentry_shield_material.density; %[kg/m3] %add this on, ignore weight contribution by SMH
re_mat_maxflux = design_variables.reentry_shield_material.maxflux; %W/m2 max heat flux the ablative material can undergo w/out failure
...
rocket.stage1.structmass = rocket.stage1.propmass*SMF;  
rocket.stage2.structmass = rocket.stage2.propmass*SMF; 

st1volume = rocket.stage1.structmass/strucmat_density; %volume of stage 1
st2volume = rocket.stage2.structmass/strucmat_density; %volume of stage 2
