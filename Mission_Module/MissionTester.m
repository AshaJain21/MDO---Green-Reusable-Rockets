...
parameters.init_sat_prod_time = 0.001;%120; %satellites per month (from https://www.cnbc.com/2020/08/10/spacex-starlink-satellte-production-now-120-per-month.html)
parameters.launcher_refurb_time = 60/30; %[months] (from rough numbers at https://www.quora.com/How-does-SpaceX-refurbish-their-Falcon-9-rockets-after-they-land-How-long-does-it-take)
...
[per_launch_mass, launch_cadences] = run_mission_module(design_variables, parameters_fast_fleet)
...
design_variables.num_of_launches=10;
design_variables.rocket_radius = 5;
[per_launch_mass, launch_cadences] = run_mission_module(design_variables, parameters_fast_nofleet)
total_time = sum(launch_cadences(1,:))
fprintf('\n========================\n')

% %TEST MISSION 4
fprintf('>> Test case 4: No fleet, no stage 1 reuse, fast satellite production (0.001 months per sat)')
design_variables.reusable_stages=[0,1];
design_variables.num_of_launches=10;
design_variables.rocket_radius = 5;
[per_launch_mass, launch_cadences] = run_mission_module(design_variables, parameters_fast_nofleet)
total_time = sum(launch_cadences(1,:))
...
design_variables.num_of_launches=10;
design_variables.rocket_radius = 5;
[per_launch_mass, launch_cadences] = run_mission_module(design_variables, parameters_slow_fleet)
total_time = sum(launch_cadences(1,:))
fprintf('\n========================\n')
...
design_variables.num_of_launches=10;
design_variables.rocket_radius = 5;
[per_launch_mass, launch_cadences] = run_mission_module(design_variables, parameters_slow_nofleet)
total_time = sum(launch_cadences(1,:))
fprintf('\n========================\n')