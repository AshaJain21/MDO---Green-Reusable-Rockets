function reentry_nox_kg_map = compute_reentry_nox_emission(second_stage_reentry_mass)
...
%     shuttle_data = shuttle_data / sum(shuttle_data);
    reentry_nox_kg(1,:) = second_stage_reentry_mass .* 0.17;
    reentry_nox_kg_map = containers.Map({'NOx'}, {reentry_nox_kg});
